...
HD_PWD='C:/Users/admin/Desktop/FPGA thi/Cau2/parallel_to_serial/parallel_to_serial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_to_serial.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parallel_to_serial.tcl -notrace
