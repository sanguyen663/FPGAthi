...
HD_PWD='C:/Users/admin/Desktop/FPGA thi/Cau2/parallel_to_serial/parallel_to_serial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_to_serial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_to_serial.tcl
