...
HD_PWD='C:/Users/Admin/Desktop/verilog/serial_to_parallel/serial_to_parallel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial2paralel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serial2paralel.tcl
