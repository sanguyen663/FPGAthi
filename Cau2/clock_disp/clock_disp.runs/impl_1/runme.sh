...
HD_PWD='C:/Users/Admin/Desktop/verilog/clock_disp/clock_disp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_7seg.tcl -notrace
