...
HD_PWD='C:/Users/Admin/Desktop/verilog/clock_disp/clock_disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_7seg.tcl
