...
HD_PWD='C:/xilinx/Downloads/Sine_wave/Sine_wave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_wave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sine_wave.tcl -notrace
