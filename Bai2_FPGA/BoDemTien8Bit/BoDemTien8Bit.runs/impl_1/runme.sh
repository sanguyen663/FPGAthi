...
HD_PWD='C:/Users/ADMIN/BoDemTien8Bit/BoDemTien8Bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter8bit.tcl -notrace
