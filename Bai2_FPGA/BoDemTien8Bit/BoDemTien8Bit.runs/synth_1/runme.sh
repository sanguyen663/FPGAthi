...
HD_PWD='C:/Users/ADMIN/BoDemTien8Bit/BoDemTien8Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter8bit.tcl
