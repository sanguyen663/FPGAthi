...
HD_PWD='C:/Users/admin/Desktop/serial_to_parallel/serial_to_parallel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serial2paralel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serial2paralel.tcl -notrace
