...
HD_PWD='C:/Users/VICTUS/Desktop/FPGAthi/bodem/bodem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log random_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source random_counter.tcl
