...
HD_PWD='C:/Users/admin/Desktop/bodem/bodem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log random_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source random_counter.tcl -notrace
